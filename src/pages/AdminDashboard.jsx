...
import TheWay from "@/components/admin/TheWay";
...
const AdminDashboard = () => {
  ...
  useEffect(() => {
    ...
    axios
      .post("https://chachachatore.com/services/admin/verify.php", { token })
      .then((res) => {
